...
{
public:
    Satellite(std::string newName, OrbitalElements newOrbit);
    ...
    Losses calculateLosses(double carrierFrequency, std::array<double,3> baseStationPositionECEF, double simTime) const;
